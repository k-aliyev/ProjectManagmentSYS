...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($errors)){
        ...
        $sql = "INSERT INTO project(id, name, description, detail, requirements, software, hardware, status, year, semester, advisor_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $db->prepare($sql);
        $stmt->execute([$id + 1, $name, $_POST["description"], $_POST["detail"],$_POST["requirements"],$_POST["software"],$_POST["hardware"],"waiting",date("Y"), $_POST["semester"], -1]);
