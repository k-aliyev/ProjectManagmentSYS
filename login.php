                ...
                <div class="card">
                    ...
                    <form method="post" action="login.php">
                        ...
                        <div class="form-outline mb-4">
                            <input type="text" name="username" id="username" class="form-control" value="<?php if (isset($item["username"])) echo $item["username"]; ?>"/>
                        ...
                        <div class="text-center">
                            ...
                            <p>View Projects without registration<a href="viewAll.php"> here</a></p>
                        </div>
                        </form>
                    </div>
                </div>
