        ...
        <?php
            foreach ($projects as $key => $value) {
              ...
              if(isset($_GET["type"]) && $_GET["type"]="r"){
                if(in_array($_SESSION["user_role"], $roles)){
                  echo "<th scope='col'>
                        ...
                        if($_SESSION["user_role"] !== "student" ){
                          echo "<a data-bs-toggle='modal' onclick='prepareDelete(this)' data-id='{$value["id"]}' data-bs-target='#deleteModal' href='#'>delete</a>";
                        }
   
                        echo '<br>';
                      if($_SESSION["user_role"] === "student" ){
                        echo "<a href='uploadFiles.php'> Add Files +</a>";
                      }
                      echo '<br>';
                      if($_SESSION["user_role"] === "instructor" ){
                        echo "<a href='addComments.php?user_id={$_SESSION["user_id"]}&project_id={$value["id"]}'> Add Comments +</a>";
                      }
                      echo "</th>";
                }
              }
                ...
                echo "<th scope='col'>
                        <a href='view.php?id={$value["id"]}&name={$value["name"]}'>view</a>
                      </th>";
              } 
              echo "</tr>";
            }
